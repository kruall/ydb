...
SIMPLE_CLASS_DEF_COMP_DISK_PARAMS(TSimple3Put1SeqFlatGetAll)
SIMPLE_CLASS_DEF_COMP_DISK_PARAMS(TSimple3Put1SeqFlatIndexGetAll)
...
SIMPLE_CLASS_DEF_COMP_DISK_PARAMS(TSimple3PutRangeFlatGetAllForward)
SIMPLE_CLASS_DEF_COMP_DISK_PARAMS(TSimple3PutRangeFlatGetAllBackward)
