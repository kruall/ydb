...
- Entry points that are allowed to call `sys.exit()`:
  - `ydb/tools/mnc/cli/main.py` for the `mnc` CLI.
  - `ydb/tools/mnc/agent/main.py` for the agent server.
- Raise exceptions and let the entry point decide how to print the error and exit.
