...
namespace NActors {
    ...
    void TActorContext::Schedule(TInstant deadline, IEventHandle* ev, ISchedulerCookie* cookie) const {
        ExecutorThread.Schedule(deadline, ev, cookie);
    }

    void TActorContext::Schedule(TMonotonic deadline, IEventHandle* ev, ISchedulerCookie* cookie) const {
        ExecutorThread.Schedule(deadline, ev, cookie);
    }

    void TActorContext::Schedule(TDuration delta, IEventHandle* ev, ISchedulerCookie* cookie) const {
