...
namespace NActors {
    ...
    struct TActorContext: public TActivationContext {
        ...
        void Schedule(TInstant deadline, IEventHandle* ev, ISchedulerCookie* cookie = nullptr) const;
        void Schedule(TMonotonic deadline, IEventHandle* ev, ISchedulerCookie* cookie = nullptr) const;
        void Schedule(TDuration delta, IEventHandle* ev, ISchedulerCookie* cookie = nullptr) const;
